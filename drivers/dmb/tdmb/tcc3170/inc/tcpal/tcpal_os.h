...
s32 tcpal_irq_stream_callback(s32 _dev_idx, u8 *_stream, s32 _size, u8 _subch_id, u8 _type);
#else
TCBB_FUNC s32 tcpal_irq_stream_callback(u8 *_stream, s32 _size, u8 _subch_id, u8 _type);
#endif
