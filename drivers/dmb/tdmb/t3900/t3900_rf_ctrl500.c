...
static INC_UINT8 g_acKorI2CValue_12000[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
  { //12000KHz 7AK.dat (175.280Mhz)
    ...
    0x4D, 0x0C, 0xE8, 0x01, 0xF4, 0xC1, 0x88, 0xEC, 0xE0, 0x10, 0x40, 0xFC, 0x00, 0x00, 0x00, 0x00, 
  ...
  { //12000KHz 7BK.dat (177.008Mhz)
    ...
    0x4D, 0x09, 0x11, 0x01, 0xF4, 0xC1, 0x88, 0xEC, 0xE0, 0x10, 0x40, 0xFC, 0x00, 0x00, 0x00, 0x00, 
    0xFF, 0x01, 0x00, 0x70, 0x4C, 0xF0, 0x8C, 0xF0, 0x80, 0xC0, 0xB0, 0x70, 0x70, 0x80, 0x10, 0x00, 
    0xEE, 0xE0, 0x33, 0x44, 0x48, 0x44, 0x6E, 0x68, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x0B, 0x2B, 
    0x00, 0x80, 0x60, 0x00, 0x00, 0x00, 0x94, 0x44, 0x00, 0x17, 0x17, 0x18, 0x18, 0x0E, 0x04, 0x00, 
    0x00, 0x00, 0xFB, 0xB0, 0x68, 0x20, 0x00, 0x08, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  ...
  { //12000KHz 7CK.dat (178.736Mhz)
    ...
    0x4D, 0x05, 0x3A, 0x01, 0xF4, 0xC1, 0x88, 0xEC, 0xE0, 0x10, 0x40, 0xFC, 0x00, 0x00, 0x00, 0x00, 
  ...
  { //12000KHz 10BK.dat (195.008Mhz)
    ...
    0x6D, 0x09, 0x12, 0x01, 0xF4, 0xC1, 0x88, 0xEC, 0xE0, 0x10, 0x40, 0xFC, 0x00, 0x00, 0x00, 0x00, 
...
static INC_UINT8 g_acKorI2CValue_19200[MAX_KOREABAND_FULL_CHANNEL][RF500_REG_CTRL] = 
{
  ...
  { //19200KHz 12BK.dat (207.008Mhz)
    0x55, 0x9F, 0xF1, 0xF8, 0x02, 0x41, 0xFC, 0x00, 0x00, 0xC0, 0x00, 0x0C, 0xC3, 0x00, 0xC0, 0x40, 
    0x5A, 0x80, 0x03, 0xE8, 0x0C, 0xC0, 0x88, 0x33, 0x08, 0xF0, 0xF0, 0xD0, 0x02, 0x00, 0x15, 0x46, 
    0x4D, 0x09, 0x11, 0x03, 0xE8, 0xC1, 0x88, 0x08, 0xE0, 0x10, 0x40, 0xFC, 0x00, 0x00, 0x00, 0x00, 
...
INC_UINT8 INC_RF500_START(INC_UINT8 ucI2CID, INC_UINT32 ulRFChannel, ENSEMBLE_BAND ucBand)
{
  ...
  if(ucBand == KOREA_BAND_ENABLE){
    //TDMB_MSG_INC_BB("[%s] KOREA_BAND_ENABLE\n", __func__);
    
    uiPos = INC_FIND_KOR_FREQ(ulRFChannel);

    //TDMB_MSG_INC_BB("[%s] uiPos[%d]\n", __func__, uiPos);
  ...
  //TDMB_MSG_INC_BB("[%s] pDataBuff[%x]\n", __func__, (unsigned int)pDataBuff);
  if(pDataBuff == INC_NULL) return INC_ERROR;

  if(INC_RF500_I2C_WRITE(ucI2CID, pDataBuff, RF500_REG_CTRL) == INC_ERROR) return INC_ERROR;

#if 1//BOARD_VER < TP10 //use for I/F debugging.
  // RF register R/W compare ... by I&C jhjung
