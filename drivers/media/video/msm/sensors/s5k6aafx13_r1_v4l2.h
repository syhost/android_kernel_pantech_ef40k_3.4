...
#define S5K6AAFX13_CFG_BRIGHT_MAX_PARAMS 		18//8
...
#define S5K6AAFX13_CFG_PREVIEW_FPS_MAX_PARAMS  41	 //2012 03 28  42//28//24
...
//flicker
	...
	const struct s5k6aafx13_i2c_reg_conf *streaming_off_settings;
	uint16_t streaming_off_settings_size;
	const struct s5k6aafx13_i2c_reg_conf *streaming_on_settings;
...
//WSH
    ...
    const unsigned char *init_burst_settings_14;
    uint16_t    init_burst_settings_size_14;
    const unsigned char *init_burst_settings_15;
    uint16_t    init_burst_settings_size_15;
    const unsigned char *init_burst_settings_16;
    uint16_t    init_burst_settings_size_16;
    const unsigned char *init_burst_settings_17;
    uint16_t    init_burst_settings_size_17;
    const unsigned char *init_burst_settings_18;
    uint16_t    init_burst_settings_size_18;
    const unsigned char *init_burst_settings_19;
    uint16_t    init_burst_settings_size_19;
    const unsigned char *init_burst_settings_20;
    uint16_t    init_burst_settings_size_20;

    const unsigned char *init_burst_settings_21;
    uint16_t    init_burst_settings_size_21;
    const unsigned char *init_burst_settings_22;
    uint16_t    init_burst_settings_size_22;
    const unsigned char *init_burst_settings_23;
    uint16_t    init_burst_settings_size_23;
    const unsigned char *init_burst_settings_24;
    uint16_t    init_burst_settings_size_24;
    const unsigned char *init_burst_settings_25;
    uint16_t    init_burst_settings_size_25;
    const unsigned char *init_burst_settings_26;
    uint16_t    init_burst_settings_size_26;
    const unsigned char *init_burst_settings_27;
    uint16_t    init_burst_settings_size_27;
    const unsigned char *init_burst_settings_28;
    uint16_t    init_burst_settings_size_28;
    const unsigned char *init_burst_settings_29;
    uint16_t    init_burst_settings_size_29;
    const unsigned char *init_burst_settings_30;
    uint16_t    init_burst_settings_size_30;

    const unsigned char *init_burst_settings_31;
    uint16_t    init_burst_settings_size_31;
    const unsigned char *init_burst_settings_32;
    uint16_t    init_burst_settings_size_32;
    const unsigned char *init_burst_settings_33;
    uint16_t    init_burst_settings_size_33;
    const unsigned char *init_burst_settings_34;
    uint16_t    init_burst_settings_size_34;
    const unsigned char *init_burst_settings_35;
    uint16_t    init_burst_settings_size_35;
    const unsigned char *init_burst_settings_36;
    uint16_t    init_burst_settings_size_36;
    const unsigned char *init_burst_settings_37;
    uint16_t    init_burst_settings_size_37;
    const unsigned char *init_burst_settings_38;
    uint16_t    init_burst_settings_size_38;    
    const unsigned char *init_burst_settings_39;
