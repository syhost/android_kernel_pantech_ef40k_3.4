...
{		
#ifdef BURST_MODE_INIT//20110519 tune
...
#if 1 //BOARD_VER_GE(TP15) || ((MODEL_ID == MODEL_EF35L) &&  BOARD_VER_GE(TP10))//change to TP15 at SMT TP20 by KHY	
...
static const unsigned char s5k6aafx13_burst_cfg_2[] = 
{
    0x0F,0x12,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

static const unsigned char s5k6aafx13_burst_cfg_3[] = 
{
    0x0F,0x12,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

static const unsigned char s5k6aafx13_burst_cfg_4[] = 
{
    0x0F,0x12,
    0x00, 0x00, 0x00, 0x02, 0x00, 0x04, 0x00, 0x04, 0x00, 0x05, 0x00, 0x05,
};

static const unsigned char s5k6aafx13_burst_cfg_5[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_6[] = 
{
    0x0F,0x12,
    0x41, 0x0a, 0x00, 0x00, 0xA3, 0x16, 0x00, 0x00,
};

static const unsigned char s5k6aafx13_burst_cfg_7[] = 
{
    0x0F,0x12,
    0x41, 0x0a, 0x00, 0x00, 0xA3, 0x16, 0x00, 0x00,
};

static const unsigned char s5k6aafx13_burst_cfg_8[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_9[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_10[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_11[] = 
{
    0x0F,0x12,
    0x00, 0x00, 0x02, 0x80, 0x02, 0x00, 0x00, 0x0E, 0x00, 0x0F, 
};

static const unsigned char s5k6aafx13_burst_cfg_12[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_13[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_14[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_15[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_16[] = 
{
    0x0F,0x12,
    0x03, 0x4A, 0x00, 0x00, 0x01, 0x76, 0x00, 0x00, 0x71, 0xB8, 0x00, 0x00,
};

static const unsigned char s5k6aafx13_burst_cfg_17[] = 
{
    0x0F,0x12,
    0x0b, 0xb8, 0x00, 0x96, 0x0B, 0xB8,
};

static const unsigned char s5k6aafx13_burst_cfg_18[] = 
{
    0x0F,0x12,
    0x00, 0x1B, 0x00, 0x0E, 0x00, 0x08, 0x00, 0x04,
};

static const unsigned char s5k6aafx13_burst_cfg_19[] = 
{
    0x0F,0x12,
    0x05, 0x3C, 0x03, 0xb0, 0x05, 0x5C,
};

static const unsigned char s5k6aafx13_burst_cfg_20[] = 
{
    0x0F,0x12,
    0x0E, 0xC8, 0x10, 0x22, 0x10, 0xBB, 0x10, 0xC9, 0x11, 0x49, 0x11, 0xFD, 0x00, 0xB8, 0x00, 0xB2,
};

static const unsigned char s5k6aafx13_burst_cfg_21[] = 
{
    0x0F,0x12,
    0x02, 0x9A, 0x03, 0x44, 0x03, 0xFB,
};

static const unsigned char s5k6aafx13_burst_cfg_22[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_23[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_24[] = 
{
    0x0F,0x12,
    0x00, 0xBF, 0x00, 0xE6, 0x01, 0x04, 0x01, 0x30, 0x01, 0x70, 0x01, 0xA3,
};

static const unsigned char s5k6aafx13_burst_cfg_25[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_26[] = 
{
    0x0F,0x12,
...
static const unsigned char s5k6aafx13_burst_cfg_27[] = 
{
    0x0F,0x12,
    0x00, 0x16, 0x00, 0x28, 0x00, 0x96, 0x01, 0xF4, 0x07, 0xD0,
};

static const unsigned char s5k6aafx13_burst_cfg_28[] = 
{
    0x0F,0x12,
    0x00, 0x30, 0x00, 0x46, 0x00, 0x88, 0x02, 0x05, 0x02, 0xBC,
};

static const unsigned char s5k6aafx13_burst_cfg_29[] = 
{
    0x0F,0x12,
    ...
    0x01, 0x00, 0x80, 0x4c, 0x01, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 
...
static const unsigned char s5k6aafx13_burst_cfg_30[] = 
{
    0x0F,0x12,
    0x17, 0x70, 0x2E, 0xE0, 0x2E, 0xE0, 0x17, 0x70, 0x2E, 0xE0, 0x2E, 0xE0,
};

static const unsigned char s5k6aafx13_burst_cfg_31[] = 
{
    0x0F,0x12,
    0x02, 0x80, 0x01, 0xE0, 0x00, 0x05,
};

static const unsigned char s5k6aafx13_burst_cfg_32[] = 
{
    0x0F,0x12,
    0x2E, 0xE0, 0x2E, 0xE0, 0x00, 0x42,
};

static const unsigned char s5k6aafx13_burst_cfg_33[] = 
{
#if 1 //BOARD_VER_GE(TP15) || ((MODEL_ID == MODEL_EF35L) &&  BOARD_VER_GE(TP10))//change to TP15 at SMT TP20 by KHY	
    0x0F,0x12,
    0x02, 0x80, 0x01, 0xE0, 0x00, 0x05,
#else    
    0x0F,0x12,
    0x05, 0x35, 0x02, 0x9A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x04, 0x00, 0x00, 0x05,
#endif    
};

static const unsigned char s5k6aafx13_burst_cfg_34[] = 
{
    0x0F,0x12,
    0x2E, 0xE0, 0x2E, 0xE0, 0x00, 0x42,
};

static const unsigned char s5k6aafx13_burst_cfg_35[] = 
{
    0x0F,0x12,
    0x05, 0x00, 0x03, 0xc0, 0x00, 0x05,
};

static const unsigned char s5k6aafx13_burst_cfg_36[] = 
{
    0x0F,0x12,
    0x2E, 0xE0, 0x2E, 0xE0, 0x00, 0x42,
};

static const unsigned char s5k6aafx13_burst_cfg_37[] = 
{
    0x0F,0x12,
    0x00, 0x01, 0x00, 0xC3, 0x00, 0x01,
};

static const unsigned char s5k6aafx13_burst_cfg_38[] = 
{
    0x0F,0x12,
    0x05, 0x00, 0x03, 0xc0, 0x00, 0x00, 0x00, 0x20, 0x05, 0x00, 0x03, 0xc0, 0x00, 0x00, 0x00, 0x20,
};

static const unsigned char s5k6aafx13_burst_cfg_39[] = 
{
    0x0F, 0x12, 
...
static const struct s5k6aafx13_i2c_reg_conf s5k6aafx13_preview_fps_settings_cfg[][S5K6AAFX13_CFG_PREVIEW_FPS_MAX_PARAMS]={
	...
	},
	{
        ...
        {0x0F12,0x0200, WORD_LEN, 0}, //01E8,     lt_uMaxAnGain1       700lux shutter       //
        {0x002A,0x2368, WORD_LEN, 0}, //217C                                              //
        {0x0F12,0x0690, WORD_LEN, 0}, //a0,  AWBBTune_EVT4_uMaxAnGain3                      ///*10*/
        {0x002A,0x021C, WORD_LEN, 0},
        {0x0F12,0x0000, WORD_LEN, 0},
        {0x002A,0x0220, WORD_LEN, 0},
        {0x0F12,0x0001, WORD_LEN, 0},
...
static const struct s5k6aafx13_i2c_reg_conf const s5k6aafx13_bright_settings_cfg[][S5K6AAFX13_CFG_BRIGHT_MAX_PARAMS] = {
	{
        ...
        {0x002A, 0x082C, WORD_LEN, 0}, //color
        {0x0F12, 0xFFC0, WORD_LEN, 0},
        {0x002A, 0x08AA, WORD_LEN, 0},
        {0x0F12, 0xFFC0, WORD_LEN, 0},
        {0x002A, 0x0928, WORD_LEN, 0},
        {0x0F12, 0xFFC0, WORD_LEN, 0},
        {0x002A, 0x09A6, WORD_LEN, 0},
        {0x0F12, 0xFFC0, WORD_LEN, 0},
        {0x002A, 0x0A24, WORD_LEN, 0},
        {0x0F12, 0xFFC0, WORD_LEN, 0},
	},
	{
		//-3
...
static const struct s5k6aafx13_i2c_reg_conf const s5k6aafx13_reflect_settings_cfg[][S5K6AAFX13_CFG_REFLECT_MAX_PARAMS] = {
	...
	},
	{
		...
		{0x0F12,0x0001, WORD_LEN, 0},  //REG_0TC_PCFG_uCaptureMirror  
#else
		{0x0F12,0x000E, WORD_LEN, 0},  //REG_0TC_PCFG_uPrevMirror   [0]x [1]y [2]xy
		{0x0F12,0x000E, WORD_LEN, 0},  //REG_0TC_PCFG_uCaptureMirror  
#endif		
		{0x002A,0x021C, WORD_LEN, 0},
		{0x0F12,0x0000, WORD_LEN, 0},
		{0x002A,0x0220, WORD_LEN, 0},
 	...
 	},
	{
		...
		{0x0F12,0x0000, WORD_LEN, 0},  //REG_0TC_PCFG_uCaptureMirror  
#else		
		{0x0F12,0x000F, WORD_LEN, 0}, //REG_0TC_PCFG_uPrevMirror   [0]x [1]y [2]xy
		{0x0F12,0x000F, WORD_LEN, 0}, //REG_0TC_PCFG_uCaptureMirror  
#endif		
		{0x002A,0x021C, WORD_LEN, 0},
		{0x0F12,0x0000, WORD_LEN, 0},
		{0x002A,0x0220, WORD_LEN, 0},
...
static const struct s5k6aafx13_i2c_reg_conf const s5k6aafx13_streaming_off_settings_cfg[] = {
	{0xFCFC, 0xD000, WORD_LEN, 0},
	{0x0028, 0xD000, WORD_LEN, 0},
	{0x002A, 0xB0B0, WORD_LEN, 0},
	{0x0F12, 0x0001, WORD_LEN, 0},	//ULPS
	{0x0028, 0x7000, WORD_LEN, 0},
	{0x002A, 0x022E, WORD_LEN, 0},
	{0x0F12, 0x0001, WORD_LEN, 0},	//#REG_TC_GP_SleepMode
	{0x0F12, 0x0001, WORD_LEN, 0},	//#REG_TC_GP_SleepModeChanged
};

static const struct s5k6aafx13_i2c_reg_conf const s5k6aafx13_streaming_on_settings_cfg[] = {
	{0xFCFC, 0xD000, WORD_LEN, 0},
	{0x0028, 0xD000, WORD_LEN, 0},
	{0x002A, 0x003A, WORD_LEN, 0},
	{0x0F12, 0x0000, WORD_LEN, 0},
	{0x002A, 0xB0B0, WORD_LEN, 0},
	{0x0F12, 0x0000, WORD_LEN, 0},	//escape ULPS mode
	{0x0028, 0x7000, WORD_LEN, 0},
	{0x002A, 0x022E, WORD_LEN, 0},
	{0x0F12, 0x0000, WORD_LEN, 0},	//#REG_TC_GP_SleepMode
	{0x0F12, 0x0001, WORD_LEN, 0},	//#REG_TC_GP_SleepModeChanged
	{0x0028, 0xD000, WORD_LEN, 0},
	{0x002A, 0x1000, WORD_LEN, 0},
	{0x0F12, 0x0001, WORD_LEN, 0},
...
struct s5k6aafx13_reg s5k6aafx13_regs = {
	.init_parm = s5k6aafx13_init_parm,
...
//reflect	
	...
	.streaming_off_settings = &s5k6aafx13_streaming_off_settings_cfg[0],
	.streaming_off_settings_size = ARRAY_SIZE(s5k6aafx13_streaming_off_settings_cfg),
	.streaming_on_settings = &s5k6aafx13_streaming_on_settings_cfg[0],
	.streaming_on_settings_size = ARRAY_SIZE(s5k6aafx13_streaming_on_settings_cfg),

#ifdef BURST_MODE_INIT
    .init_burst_settings_1 = (unsigned char *)s5k6aafx13_burst_cfg_1,
    .init_burst_settings_size_1 = ARRAY_SIZE(s5k6aafx13_burst_cfg_1),
    .init_burst_settings_2 = (unsigned char *)s5k6aafx13_burst_cfg_2,
    .init_burst_settings_size_2 = ARRAY_SIZE(s5k6aafx13_burst_cfg_2),
    .init_burst_settings_3 = (unsigned char *)s5k6aafx13_burst_cfg_3,
    .init_burst_settings_size_3 = ARRAY_SIZE(s5k6aafx13_burst_cfg_3),
    .init_burst_settings_4 = (unsigned char *)s5k6aafx13_burst_cfg_4,
    .init_burst_settings_size_4 = ARRAY_SIZE(s5k6aafx13_burst_cfg_4),
    .init_burst_settings_5 = (unsigned char *)s5k6aafx13_burst_cfg_5,
    .init_burst_settings_size_5 = ARRAY_SIZE(s5k6aafx13_burst_cfg_5),
    .init_burst_settings_6 = (unsigned char *)s5k6aafx13_burst_cfg_6,
    .init_burst_settings_size_6 = ARRAY_SIZE(s5k6aafx13_burst_cfg_6),
    .init_burst_settings_7 = (unsigned char *)s5k6aafx13_burst_cfg_7,
    .init_burst_settings_size_7 = ARRAY_SIZE(s5k6aafx13_burst_cfg_7),
    .init_burst_settings_8 = (unsigned char *)s5k6aafx13_burst_cfg_8,
    .init_burst_settings_size_8 = ARRAY_SIZE(s5k6aafx13_burst_cfg_8),
    .init_burst_settings_9 = (unsigned char *)s5k6aafx13_burst_cfg_9,
    .init_burst_settings_size_9 = ARRAY_SIZE(s5k6aafx13_burst_cfg_9),
    .init_burst_settings_10 = (unsigned char *)s5k6aafx13_burst_cfg_10,
    .init_burst_settings_size_10 = ARRAY_SIZE(s5k6aafx13_burst_cfg_10),

    .init_burst_settings_11 = (unsigned char *)s5k6aafx13_burst_cfg_11,
    .init_burst_settings_size_11 = ARRAY_SIZE(s5k6aafx13_burst_cfg_11),
    .init_burst_settings_12 = (unsigned char *)s5k6aafx13_burst_cfg_12,
    .init_burst_settings_size_12 = ARRAY_SIZE(s5k6aafx13_burst_cfg_12),
    .init_burst_settings_13 = (unsigned char *)s5k6aafx13_burst_cfg_13,
    .init_burst_settings_size_13 = ARRAY_SIZE(s5k6aafx13_burst_cfg_13),
    .init_burst_settings_14 = (unsigned char *)s5k6aafx13_burst_cfg_14,
    .init_burst_settings_size_14 = ARRAY_SIZE(s5k6aafx13_burst_cfg_14),
    .init_burst_settings_15 = (unsigned char *)s5k6aafx13_burst_cfg_15,
    .init_burst_settings_size_15 = ARRAY_SIZE(s5k6aafx13_burst_cfg_15),
    .init_burst_settings_16 = (unsigned char *)s5k6aafx13_burst_cfg_16,
    .init_burst_settings_size_16 = ARRAY_SIZE(s5k6aafx13_burst_cfg_16),
    .init_burst_settings_17 = (unsigned char *)s5k6aafx13_burst_cfg_17,
    .init_burst_settings_size_17 = ARRAY_SIZE(s5k6aafx13_burst_cfg_17),
    .init_burst_settings_18 = (unsigned char *)s5k6aafx13_burst_cfg_18,
    .init_burst_settings_size_18 = ARRAY_SIZE(s5k6aafx13_burst_cfg_18),
    .init_burst_settings_19 = (unsigned char *)s5k6aafx13_burst_cfg_19,
    .init_burst_settings_size_19 = ARRAY_SIZE(s5k6aafx13_burst_cfg_19),
    .init_burst_settings_20 = (unsigned char *)s5k6aafx13_burst_cfg_20,
    .init_burst_settings_size_20 = ARRAY_SIZE(s5k6aafx13_burst_cfg_20),

    .init_burst_settings_21 = (unsigned char *)s5k6aafx13_burst_cfg_21,
    .init_burst_settings_size_21 = ARRAY_SIZE(s5k6aafx13_burst_cfg_21),
    .init_burst_settings_22 = (unsigned char *)s5k6aafx13_burst_cfg_22,
    .init_burst_settings_size_22 = ARRAY_SIZE(s5k6aafx13_burst_cfg_22),
    .init_burst_settings_23 = (unsigned char *)s5k6aafx13_burst_cfg_23,
    .init_burst_settings_size_23 = ARRAY_SIZE(s5k6aafx13_burst_cfg_23),
    .init_burst_settings_24 = (unsigned char *)s5k6aafx13_burst_cfg_24,
    .init_burst_settings_size_24 = ARRAY_SIZE(s5k6aafx13_burst_cfg_24),
    .init_burst_settings_25 = (unsigned char *)s5k6aafx13_burst_cfg_25,
    .init_burst_settings_size_25 = ARRAY_SIZE(s5k6aafx13_burst_cfg_25),
    .init_burst_settings_26 = (unsigned char *)s5k6aafx13_burst_cfg_26,
    .init_burst_settings_size_26 = ARRAY_SIZE(s5k6aafx13_burst_cfg_26),
    .init_burst_settings_27 = (unsigned char *)s5k6aafx13_burst_cfg_27,
    .init_burst_settings_size_27 = ARRAY_SIZE(s5k6aafx13_burst_cfg_27),
    .init_burst_settings_28 = (unsigned char *)s5k6aafx13_burst_cfg_28,
    .init_burst_settings_size_28 = ARRAY_SIZE(s5k6aafx13_burst_cfg_28),
    .init_burst_settings_29 = (unsigned char *)s5k6aafx13_burst_cfg_29,
    .init_burst_settings_size_29 = ARRAY_SIZE(s5k6aafx13_burst_cfg_29),
    .init_burst_settings_30 = (unsigned char *)s5k6aafx13_burst_cfg_30,
    .init_burst_settings_size_30 = ARRAY_SIZE(s5k6aafx13_burst_cfg_30),

    .init_burst_settings_31 = (unsigned char *)s5k6aafx13_burst_cfg_31,
    .init_burst_settings_size_31 = ARRAY_SIZE(s5k6aafx13_burst_cfg_31),
    .init_burst_settings_32 = (unsigned char *)s5k6aafx13_burst_cfg_32,
    .init_burst_settings_size_32 = ARRAY_SIZE(s5k6aafx13_burst_cfg_32),
    .init_burst_settings_33 = (unsigned char *)s5k6aafx13_burst_cfg_33,
    .init_burst_settings_size_33 = ARRAY_SIZE(s5k6aafx13_burst_cfg_33),
    .init_burst_settings_34 = (unsigned char *)s5k6aafx13_burst_cfg_34,
    .init_burst_settings_size_34 = ARRAY_SIZE(s5k6aafx13_burst_cfg_34),
    .init_burst_settings_35 = (unsigned char *)s5k6aafx13_burst_cfg_35,
    .init_burst_settings_size_35 = ARRAY_SIZE(s5k6aafx13_burst_cfg_35),
    .init_burst_settings_36 = (unsigned char *)s5k6aafx13_burst_cfg_36,
    .init_burst_settings_size_36 = ARRAY_SIZE(s5k6aafx13_burst_cfg_36),
    .init_burst_settings_37 = (unsigned char *)s5k6aafx13_burst_cfg_37,
    .init_burst_settings_size_37 = ARRAY_SIZE(s5k6aafx13_burst_cfg_37),
    .init_burst_settings_38 = (unsigned char *)s5k6aafx13_burst_cfg_38,
    .init_burst_settings_size_38 = ARRAY_SIZE(s5k6aafx13_burst_cfg_38),
    .init_burst_settings_39 = (unsigned char *)s5k6aafx13_burst_cfg_39,
