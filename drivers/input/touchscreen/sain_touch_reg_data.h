...
const _sain_reg_data m_reg_data[MAX_REG_COUNT] = { 
	...
	{0, 0}, // 0F, RESERVED
	{0, 1}, // 10, TOUCH MODE
	{350, 1}, // 11, SENSITIVITY TH.
	{2, 1}, // 12, FIR COEFFICIENT
	{11, 0}, // 13, CHIP REVISION
	{95, 1}, // 14, INTERNAL FLAG
	{10, 1}, // 15, CHARGING STEP LIMIT
	...
	{4, 1}, // 1B, SW WIDTH FIR
	{1800, 1}, // 1C, CHARGING MODE SENSITIVITY TH
	{-15, 1}, // 1D, AUTO CHARING LIMIT VALUE
	{4, 1}, // 1E, AUTO CHARING STRENGTH RATIO
	{15, 1}, // 1F, AUTO CHARGING LIMIT CNT
	...
	{25, 1}, // 2A, 1st BASELINE VARIATION
	{30, 1}, // 2B, 2nd BASELINE VARIATION
	{30, 1}, // 2C, 1st BASELINE PERIOD
	{2, 1}, // 2D, 2nd BASELINE PERIOD
	{30000, 1}, // 2E, BASELINE FORCE PERIOD
	{0, 0}, // 2F, RESERVED
	{850, 1}, // 30, CALIBRATION REFERENCE
	{0, 0}, // 31, DEFAULT N COUNT
	{0, 0}, // 32, N OF CALIBRATION
	{0, 0}, // 33, CALIBRATION ACCURACY
	{128, 1}, // 34, CALIBRATION MAX N
	...
	{350, 1}, // 51, Y0 SENSITIVITY TH
	{350, 1}, // 52, LAST Y SENSITIVITY TH
	{350, 1}, // 53, X0 SENSITIVITY TH
	{350, 1}, // 54, LAST X SENSITIVITY TH
	{3, 1}, // 55, ACTIVE SENSITIVITY COEF
	{800, 1}, // 56, BUTTON SENSITIVITY TH
	{0, 0}, // 57, RESERVED
	{0, 0}, // 58, RESERVED
	{0, 0}, // 59, RESERVED
	{0, 0}, // 5A, RESERVED
	...
	{-30584, 1}, // 65, BDATA CORNER COEF1
	{17476, 1}, // 66, BDATA CORNER COEF2
	{17476, 1}, // 67, BDATA CORNER COEF3
	{0, 0}, // 68, RESERVED
	{0, 0}, // 69, RESERVED
	{0, 0}, // 6A, RESERVED
	{0, 0}, // 6B, RESERVED
	...
	{0, 0}, // 6E, RESERVED
	{0, 0}, // 6F, RESERVED
	{3, 1}, // 70, SUPPORTED BUTTON NUM
	{0, 1}, // 71, BUTTON LINE TYPE
	{16, 1}, // 72, BUTTON LINE NUM
	{3, 1}, // 73, BUTTON RANGE
	{1, 1}, // 74, BUTTON_0 START NODE
	{4, 1}, // 75, BUTTON_1 START NODE
	{8, 1}, // 76, BUTTON_2 START NODE
	...
	{7685, 1}, // 7C, MVAVG_1_VELOCITY
	{258, 1}, // 7D, MVAVG_1_SW_INC
	{0, 0}, // 7E, RESERVED
	{0, 0}, // 7F, RESERVED
	{0, 0}, // 80, RESERVED
	{0, 0}, // 81, RESERVED
	...
	{0, 0}, // 9E, RESERVED
	{0, 0}, // 9F, RESERVED
	{4, 1}, // A0, HOLD THRESHOLD
	{3, 1}, // A1, REACTION COUNT
	{80, 1}, // A2, PALM REJECT TRESHHOLD
	{80, 1}, // A3, NOISE REJECT TRESHHOLD
	{10, 1}, // A4, EDGE COEFFICIENT
	{250, 1}, // A5, STYLUS HW THRESHHOLD
	{200, 1}, // A6, ASSUME UP THRESHHOLD
	{773, 1}, // A7, NOISE REJECT HILO RATIO
	{259, 1}, // A8, CUTOFF NOISE BDATA RATIO
	{12, 1}, // A9, CUTOFF NOISE WIDTH RATIO
	{-4, 0}, // AA, EEPROM INFO
	{16, 1}, // AB, REGISTER DATA VERSION
	...
	{3, 1}, // B1, BDATA COEF2
	{3, 1}, // B2, BDATA COEF3
	{0, 1}, // B3, FINGER ATTACH VALUE
	{0, 1}, // B4, STYLUS ATTACH VALUE
	{0, 0}, // B5, OPT Q RESOLUTION
	{149, 1}, // B6, EDGE Q BIAS1_1
	{0, 1}, // B7, DELAY FOR HOST
	{158, 1}, // B8, EDGE Q BIAS2_1
	{2, 1}, // B9, BUTTON REACTION CNT
	{155, 1}, // BA, EDGE Q BIAS3_1
	{0, 1}, // BB, INT ASSERT PIN(0=INT PIN)
	{155, 1}, // BC, EDGE Q BIAS4_1
	{0, 0}, // BD, RESERVED
	{115, 1}, // BE, CORNER Q BIAS1_1
	{0, 1}, // BF, VIEW XF OFFSET
	{115, 1}, // C0, CORNER Q BIAS2_1
	{0, 1}, // C1, VIEW XL OFFSET
	{115, 1}, // C2, CORNER Q BIAS3_1
	{0, 1}, // C3, VIEW YF OFFSET
	{115, 1}, // C4, CORNER Q BIAS4_1
	{0, 1}, // C5, VIEW YL OFFSET
	{0, 1}, // C6, I2C VOLT LEVEL(0=3.3V)
	{0, 0}, // C7, RESERVED
	{0, 0}, // C8, RESERVED
	{257, 0}, // C9, FIRMWARE VERSION
	{0, 0}, // CA, RESERVED
	{0, 0}, // CB, RESERVED
	{0, 0}, // CC, RESERVED
	{0, 0}, // CD, RESERVED
	{0, 0}, // CE, RESERVED
	{0, 0}, // CF, RESERVED
	{2827, 1}, // D0, FREQ X NUM 0_1
	{3851, 1}, // D1, FREQ X NUM 2_3
	{3855, 1}, // D2, FREQ X NUM 4_5
	{3855, 1}, // D3, FREQ X NUM 6_7
	{4623, 1}, // D4, FREQ X NUM 8_9
	{4626, 1}, // D5, FREQ X NUM 10_11
	{4626, 1}, // D6, FREQ X NUM 12_13
	{4626, 1}, // D7, FREQ X NUM 14_15
	{12079, 1}, // D8, FREQ X NUM 16_17
	{5140, 1}, // D9, FREQ X NUM 18_19
	{0, 0}, // DA, RESERVED
	{0, 0}, // DB, RESERVED
	{0, 0}, // DC, RESERVED
	{0, 0}, // DD, RESERVED
