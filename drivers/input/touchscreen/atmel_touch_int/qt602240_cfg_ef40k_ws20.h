...
#define T8_CHRGTIME                 30
#define T8_TCHDRIFT             	0	//5
#define T8_DRIFTST               	10	//20
#define T8_TCHAUTOCAL            	0
#define T8_SYNC                  	0
#define T8_ATCHCALST             	9
#define T8_ATCHCALSTHR           	35	//0
...
#define T9_AKSCFG                       0
#define T9_BLEN                         17
static uint8_t T9_TCHTHR[4] = {60,60,60,60};
#define T9_TCHDI                        3
#define T9_ORIENT                       5
...
static uint8_t T9_TCHHYST[4] = {18,18,18,18};
...
#define T48_XEDGECTRL           	146	//0	//146
#define T48_XEDGEDIST           	60	//0	//60 
#define T48_YEDGECTRL           	149	//0	//149
#define T48_YEDGEDIST           	68	//0	//68 
