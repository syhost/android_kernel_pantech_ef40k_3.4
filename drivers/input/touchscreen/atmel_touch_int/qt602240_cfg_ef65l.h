...
/*
 	Reserved = 0,
	White_G3F_OpenX = 1,	
 	Black_G2F_FloodedX = 2,
 	Reserved = 3
*/
static ito_table_element ito_table[] = {
	{-9999,	0},	   // 0 : reserved				
	{0,	600},      // 0M Ohm, 0V  	1 : White
	{600,	1500}, // 1M Ohm, 1.0V	2 : Black
...
#define T9_BLEN                 17
#ifdef ITO_TYPE_CHECK
static uint8_t T9_TCHTHR[4] = {35,40,35,35}; 
#else
#define T9_TCHTHR               35
#endif
#define T9_TCHDI                2
...
#define T9_MOVHYSTI    			9
#define T9_MOVHYSTN     		2
#define T9_MOVFILTER			0 
#define T9_NUMTOUCH             5 // MAX_NUM_FINGER
...
#define T9_YLOCLIP              0
#define T9_YHICLIP				0
#define T9_XEDGECTRL			136 //0
#define T9_XEDGEDIST			60 //0
#define T9_YEDGECTRL			0
#define T9_YEDGEDIST			0
#define T9_JUMPLIMIT			10 //20 
#ifdef ITO_TYPE_CHECK
static uint8_t T9_TCHHYST[4] = {8,10,8,8}; //8 
#else
#define T9_TCHHYST              8 //8 //11//7 //18  /* V2.0 or MXT224E added */
#endif
...
#define T25_CTRL                        0
#define T25_CMD                         0
#define T25_SIGLIM_0_UPSIGLIM        	0//13500
#define T25_SIGLIM_0_LOSIGLIM        	0//5500
#define T25_SIGLIM_1_UPSIGLIM        	0//13500
#define T25_SIGLIM_1_LOSIGLIM        	0//5500
...
#define T48_XLOCLIP             	3   
#define T48_XHICLIP             	0  
#define T48_YLOCLIP             	45  
#define T48_YHICLIP             	45  
#define T48_XEDGECTRL           	151 
#define T48_XEDGEDIST           	50  
