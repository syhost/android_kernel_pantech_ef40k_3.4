...
#define FEATURE_SKY_AVOID_DEADLOCK
#endif
...
{
#ifdef PANTECH_AVOID_DEADLOCK //p12911 : ef33s sensor patch
	return 0;
#else
...
{
#ifdef PANTECH_AVOID_DEADLOCK // p12911. 110814 MIRACH_J was lcd lockup caused by geomagnetic's work function. --> don't use msleep in work function.
	// nothing to do.
#else
    msleep(ms);
#endif
...
#ifdef YAS_MAG_MANUAL_OFFSET //p12911 : ef33s sensor patch
static ssize_t 
