		...
		struct ext_slave_platform_data *pdata, unsigned char *data)
{
	...
	// P12095 110308 edited rawdata to offset attached rawdata and transmited value's unit nT to mT
	/*
	rawfixed[0] = (short) (raw[0]>>8)*41;
	rawfixed[1] = (short) (raw[1]>>8)*41;
	rawfixed[2] = (short) (raw[2]>>8)*41;
	*/
	rawfixed[0] = (short) (xyz[0]/100);
	rawfixed[1] = (short) (xyz[1]/100);
	rawfixed[2] = (short) (xyz[2]/100);

	//printk(" [%d] [%d] [%d] => [%d] [%d] [%d]\n", raw[0], raw[1], raw[2], rawfixed[0], rawfixed[1], rawfixed[2]);
	...
	//printk("[Accuracy=%d] [%d] [%d] [%d] => [%d] [%d] [%d]\n", accuracy, raw[0], raw[1], raw[2], rawfixed[0], rawfixed[1], rawfixed[2]);
