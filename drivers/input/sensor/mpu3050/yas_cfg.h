...
#endif
#define YAS_GYRO_DRIVER                     (YAS_GYRO_DRIVER_NONE) //LS5 TEAM SHS : ef33s patch [2011-08-17]
...
/*----------------------------------------------------------------------------*/
/*                    Geomagnetic lock Configuration                   */
/*----------------------------------------------------------------------------*/
#define PANTECH_AVOID_DEADLOCK //LS5 TEAM SHS : ef33s patch [2011-08-17]
/*----------------------------------------------------------------------------*/
