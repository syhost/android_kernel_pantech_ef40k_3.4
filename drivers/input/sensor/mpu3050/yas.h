...
#define YAS_VERSION	"7.0.1a"
//APQ8060 MODEL
#if defined(CONFIG_MACH_MSM8X60_EF39S)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 5 // bottom-lower-right
#elif  defined(CONFIG_MACH_MSM8X60_EF40K)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 2 // bottom-lower-right
#elif  defined(CONFIG_MACH_MSM8X60_EF40S)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 2 // top-lower-right, YAS530_ :: 20110929 Hagen
#elif  defined(CONFIG_MACH_MSM8X60_EF65L)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 7 // bottom-lower-left	- PZ2123
#elif  defined(CONFIG_MACH_MSM8X60_EF33S)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 6 // bottom-lower-right
#elif defined(CONFIG_MACH_MSM8X60_EF35L)
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 3 // top-lower-left
