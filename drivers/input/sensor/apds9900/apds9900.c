...
#define EF33_34_PP_WINDOW_TEST // enable on PP and MP board by Heojiman K.
#endif
#if defined(CONFIG_MACH_MSM8X60_EF39S) || defined(CONFIG_MACH_MSM8X60_EF40K) || defined(CONFIG_MACH_MSM8X60_EF40S)  // 20110429, FEATURE-WORK
#define APDS9900_PS_INT_N				34
#elif defined(CONFIG_MACH_MSM8X60_EF65L)
#define APDS9900_PS_INT_N				46
#else
#define APDS9900_PS_INT_N						124
#endif

#define APDS9900_PS_IRQ							gpio_to_irq(APDS9900_PS_INT_N)
#if defined(CONFIG_MACH_MSM8X60_EF39S) 
#define APDS9900_THRESHOLD_HIGH			40
#define APDS9900_THRESHOLD_LOW			20	
...
#elif defined(CONFIG_MACH_MSM8X60_EF65L)
#define APDS9900_THRESHOLD_HIGH			30
#define APDS9900_THRESHOLD_LOW			25
#elif defined(CONFIG_MACH_MSM8X60_EF33S) || defined(CONFIG_MACH_MSM8X60_EF34K)
#if defined(EF33_34_PP_WINDOW_TEST)
#define APDS9900_THRESHOLD_HIGH			35
#define APDS9900_THRESHOLD_LOW			25
#elif defined(EF34_WHITE_WINDOW_TEST)
#define APDS9900_THRESHOLD_HIGH			(30+24)
#define APDS9900_THRESHOLD_LOW			(15+24)
#else
#define APDS9900_THRESHOLD_HIGH			30
#define APDS9900_THRESHOLD_LOW			15
#endif // EF33_34_PP_WINDOW_TEST
#elif defined(CONFIG_MACH_MSM8X60_EF35L)
// 110418 applied
#define APDS9900_THRESHOLD_HIGH			50
#define APDS9900_THRESHOLD_LOW			26
#else
#define APDS9900_THRESHOLD_HIGH			30
#define APDS9900_THRESHOLD_LOW			15
#endif
...
#if defined(CONFIG_MACH_MSM8X60_EF39S) || defined(CONFIG_MACH_MSM8X60_EF40K)|| defined(CONFIG_MACH_MSM8X60_EF40S) || defined(CONFIG_MACH_MSM8X60_EF65L) || defined(CONFIG_MACH_MSM8X60_EF33S) || defined(CONFIG_MACH_MSM8X60_EF34K)|| defined(CONFIG_MACH_MSM8X60_EF35L)
#define ALS_COEF_GA 85 // EF33-110421
#else //CONFIG_EF35_BOARD
#define ALS_COEF_GA 64 
#endif
...
int apds9900_set_irq(bool enable)
{
	...
	if ( enable ) {
		// 4.1 enable irq
		ret = request_irq( APDS9900_PS_IRQ, &apds9900_irq_handler, IRQF_TRIGGER_FALLING | IRQF_NO_SUSPEND, "apds9900_ps_irq", 0 );
		if (ret) {
