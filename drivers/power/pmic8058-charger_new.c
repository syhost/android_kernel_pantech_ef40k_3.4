...
static int pm8058_if_start_charging(struct sky_charger *chg)
{
	return 0;
}

static int pm8058_if_stop_charging(struct sky_charger *chg)
{
	return 0;
}

static int pm8058_if_set_current_limit(struct sky_charger *chg, int current_ma)
{
	return 0;
}

static int pm8058_if_get_current_limit(struct sky_charger *chg)
{
	return 0;
}

static int pm8058_if_set_charging_current(struct sky_charger *chg, int current_ma)
{
	return 0;
}

static int pm8058_if_get_charging_current(struct sky_charger *chg)
{
	return 0;
}

static int pm8058_if_set_recharging_valtage(struct sky_charger *chg, int current_ma)
{
	return 0;
}

static int pm8058_if_get_recharging_valtage(struct sky_charger *chg)
{
	return 0;
}
	
static int pm8058_if_get_charging_status(struct sky_charger *chg)
{
	return 0;
}

static struct sky_charger charger_ops = {
	.data_type = SKY_CHARGER,
	.name = "pmic8058_charger",
	.data = NULL,

	.start_charging = pm8058_if_start_charging,
	.stop_charging = pm8058_if_stop_charging,
	.set_current_limit = pm8058_if_set_current_limit,
	.set_charging_current = pm8058_if_set_charging_current,
	.set_recharging_valtage = pm8058_if_set_recharging_valtage,
	.get_current_limit = pm8058_if_get_current_limit,
	.get_charging_current = pm8058_if_get_charging_current,
	.get_recharging_valtage = pm8058_if_get_recharging_valtage,
	.get_charging_status = pm8058_if_get_charging_status,
};
...
#ifndef CONFIG_SKY_CHARGER_BATTERY
...
#ifdef CONFIG_SKY_CHARGER_BATTERY
	//registor
	sky_battery_register(&charger_ops);
#endif
