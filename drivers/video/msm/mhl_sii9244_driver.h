...
#define F_MHL_USB_SW_CONTROL_BUG_FIX // 20110811, kkcho, usb-sw control at the boot-up. 
#define MHL_REMOCON_CONTROL  // 20110526, kkcho, for RCP_FUNC
#define MHL_WAKEUP_TIMER_MODIFY // 20110715, kkcho Pre-1st working
#define F_MHL_CABLE_DETECT_BUG_PIECEOUT // 20110819, kkcho,  phone-reset
//#define MHL_DEBUG // 20111205, kkcho, for debug_message

#define PANTECH_FUSION2_MHL_DETECT // 20130710, kkcho, 1st add
//#define PANTECH_FUSION2_MHL_DETECT_2ND // 20130710, kkcho, 2nd add if need...
...
#ifndef CONFIG_PANTECH_F_CHECK_INT
#define CONFIG_PANTECH_F_CHECK_INT
#endif
/*
...
#define	T_SRC_RSEN_DEGLITCH			(250)	// Do. change 100->250 (150)

// Wait this much after connection before reacting to RSEN (300-500ms)
// Per specs between 300 to 500 ms
#define	T_SRC_RXSENSE_CHK			(500)  // Do. change 200->500 kkcho_1212, change 1119	  300->200	
