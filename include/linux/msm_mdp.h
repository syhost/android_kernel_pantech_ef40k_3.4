...
// 130626 p14198
// CONFIG_PANTECH_LCD_SKYDISP_SUPPORT_OVERLAY_COMMIT is kernel define.
// PANTECH_LCD_SUPPORT_SKIP_COMPOSITION              is framework define.
#if defined(CONFIG_PANTECH_LCD_SKYDISP_SUPPORT_OVERLAY_COMMIT) || defined(PANTECH_LCD_SUPPORT_SKIP_COMPOSITION)
#define MSMFB_OVERLAY_COMMIT      _IOW(MSMFB_IOCTL_MAGIC, 163, unsigned int)
#endif

#ifdef CONFIG_PANTECH_LCD_VEIL_VIEW
#define MSMFB_SKY_VEIL_ENABLE       _IOW(MSMFB_IOCTL_MAGIC, 200,   struct msmfb_veil_view)
#define MSMFB_SKY_VEIL_SET          _IOW(MSMFB_IOCTL_MAGIC, 201,   struct msmfb_veil_view)
#endif

#ifdef CONFIG_PANTECH_LCD_RESET
#define MSMFB_PANTECH_LCD_RESET_INIT    _IOW(MSMFB_IOCTL_MAGIC, 202, unsigned int)
#endif
#ifdef CONFIG_PANTECH_LCD_FORCE_ONOFF 
#define MSMFB_PANTECH_LCD_FORCE_ONOFF   _IOW(MSMFB_IOCTL_MAGIC, 203, unsigned int)
#endif
#ifdef CONFIG_PANTECH_LCD_RECOVERY_MINUI_USED// 130708 p14777 jang BLOCKED 
#define MSMFB_PANTECH_MDP_CLOCK_MAX   _IOW(MSMFB_IOCTL_MAGIC, 204, unsigned int)
#endif
